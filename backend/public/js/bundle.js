...
},{"core-js/shim":"../../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../../node_modules/core-js/fn/regexp/escape.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW8tZWxzaGVteSIsImEiOiJjbWZrMXExZmMwNnF2MmpzOXdxdmFvc2ZtIn0._O_XBauKEQ6rfY1rwzkrxg';
...
exports.signup = exports.logout = exports.login = exports.editTour = void 0;
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(name, email, password, passwordConfirm) {
    var res, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 1:
          ...
          console.log(res);
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'signup in successfuly');
            // window.setTimeout(() => {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        ...
        case 2:
          _context3.p = 2;
          _t3 = _context3.v;
          (0, _alert.showAlert)('error', 'fail durning logout please try again');
        case 3:
...
var editTour = exports.editTour = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(id, formData) {
    var res, _err$response, _err$response2, _t4;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          _context4.p = 0;
          _context4.n = 1;
          return _axios.default.patch("/api/v1/tours/edit/".concat(id), formData, {
            headers: {
              'Content-Type': 'multipart/form-data'
            }
          });
        case 1:
          res = _context4.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Tour Edited successfully!');
            tourForm.reset();
          }
          _context4.n = 3;
          break;
        case 2:
          _context4.p = 2;
          _t4 = _context4.v;
          console.error(((_err$response = _t4.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || _t4);
          (0, _alert.showAlert)('error', ((_err$response2 = _t4.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 ? void 0 : _err$response2.message) || _t4.message);
        case 3:
          return _context4.a(2);
      }
    }, _callee4, null, [[0, 2]]);
  }));
  return function editTour(_x7, _x8) {
...
var upDateSettings = exports.upDateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(type, data) {
    var url, res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type, " update successfly"));
            setTimeout(function () {
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      var currentPassword, password, passwordConfirm, saveBtn;
      return _regenerator().w(function (_context) {
...
if (tourForm) {
  tourForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(e) {
      var formData, imageCoverInput, imagesInput, i;
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          case 0:
            ...
            for (i = 0; i < imagesInput.files.length; i++) {
              formData.append('images', imagesInput.files[i]); // الاسم 'images' كما في multer.array('images')
            }
            _context3.n = 1;
            return (0, _login.editTour)('68d4608644106026abde528e', formData);
          case 1:
            return _context3.a(2);
        }
      }, _callee3);
...
},{"babel-polyfill":"../../node_modules/babel-polyfill/lib/index.js","./mapbox.js":"mapbox.js","./login.js":"login.js","./updateSettings.js":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
